...
export default function App() {
  ...
  // AAII — fetched weekly by GitHub Actions, served as static JSON
  useEffect(() => {
    if (!loggedIn) return
  ...
  const fetchAll = useCallback(async () => {
    ...
    try {
      ...
      if (Object.keys(map).length === 0) throw new Error('No data returned.')
      setQuotes(map)
